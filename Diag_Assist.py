...
API_KEY = "AIzaSyCInBCFo4UcNACayGtBZCXe8XxpTRohFiA"  # Replace with your Gemini API Key
...
def display_results(json_data, images):
    ...
    with tab2:
        ...
        if differential_diagnosis: #Check if its empty!
            ...
            st.write(f"**Severity:** {json_data.get('severity', 'N/A')}")
            st.write(f"**Risk Factors:** {json_data.get('risk_factors', 'N/A')}")
        else:
